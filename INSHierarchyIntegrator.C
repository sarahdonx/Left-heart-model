...
/////////////////////////////Liuyang, this is to input surface mesh for each chamber: LA and LV 
void INSHierarchyIntegrator::inputHeartMesh(std::vector<int> LVVex_List,std::vector<double> LVVex_Point, int LVVex_Number,std::vector<int> LAVex_List,std::vector<double> LAVex_Point, int LAVex_Number,int Energy_flag)
{
	d_LVVex_List=LVVex_List;
	d_LVVex_Point=LVVex_Point;
	d_LVVex_Number=LVVex_Number;
	d_LAVex_List=LAVex_List;
	d_LAVex_Point=LAVex_Point;
	d_LAVex_Number=LAVex_Number;
	d_Energy_flag=Energy_flag;
	return;
}
/////////////////////////////Liuyang
/////////////////////////////// PROTECTED ////////////////////////////////////
