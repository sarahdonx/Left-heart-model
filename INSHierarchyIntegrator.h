...
public:
	...
	///////////Liuyang Modified						
	void inputHeartMesh(std::vector<int> LVVex_List,std::vector<double> LVVex_Point, int LVVex_Number,std::vector<int> LAVex_List,std::vector<double> LAVex_Point, int LAVex_Number,int Energy_flag);						
	///////////Liuyang Modified	
protected:
    /*!
	...
	/////////////Liuyang
	std::vector<int> d_LVVex_List;
	std::vector<double> d_LVVex_Point;
	int d_LVVex_Number;
	std::vector<int> d_RVVex_List;
	std::vector<double> d_RVVex_Point;
	int d_RVVex_Number;
	std::vector<int> d_LAVex_List;
	std::vector<double> d_LAVex_Point;
	int d_LAVex_Number;
	std::vector<int> d_RAVex_List;
	std::vector<double> d_RAVex_Point;
	int d_RAVex_Number;
	int d_Energy_flag;
		/////////////Liuyang
private:
