...
private:
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////Added By Liuyang Feng on 7th MAR, 2017
	int d_in_KE_U_current_idx,d_in_KE_U_new_idx,d_in_KE_U_scratch_idx,d_in_PP_current_idx,d_in_PP_new_idx,d_in_PP_scratch_idx,d_in_VW_US_current_idx,d_in_VW_US_new_idx,d_in_VW_US_scratch_idx,d_in_KE_current_idx,d_in_KE_new_idx,d_in_KE_scratch_idx,d_in_CW_current_idx,d_in_CW_new_idx,d_in_CW_scratch_idx,d_in_PW_current_idx,d_in_PW_new_idx,d_in_PW_scratch_idx,d_in_VW_current_idx,d_in_VW_new_idx,d_in_VW_scratch_idx,d_in_FSI_current_idx,d_in_FSI_new_idx,d_in_FSI_scratch_idx,d_in_KE_idx,d_in_CW_idx,d_in_PW_idx,d_in_VW_idx,d_in_FSI_idx,d_in_heart_idx;
	SAMRAI::tbox::Pointer<SAMRAI::pdat::CellVariable<NDIM, double> > d_KE_cc_var,d_CW_cc_var,d_PW_cc_var,d_VW_cc_var,d_FSI_cc_var,d_heart_cc_var;
	SAMRAI::tbox::Pointer<SAMRAI::pdat::SideVariable<NDIM, double> > d_KE_U_sc_var,d_PP_sc_var,d_VW_U_sc_var,d_VW_US_sc_var,d_KE_sc_var,d_CW_sc_var,d_PW_sc_var,d_VW_sc_var,d_FSI_sc_var;
	SAMRAI::tbox::Pointer<SAMRAI::xfer::VariableFillPattern<NDIM> > d_LYF_U_fill_pattern,d_LYF_P_fill_pattern;
	std::vector<SAMRAI::solv::RobinBcCoefStrategy<NDIM>*> d_LYF_U_bc_coefs;
	SAMRAI::solv::RobinBcCoefStrategy<NDIM>* d_LYF_P_bc_coef;
	SAMRAI::tbox::Pointer<IBTK::HierarchyGhostCellInterpolation> d_LYF_hier_bdry_fill;
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////Added By Liuyang Feng on 7th MAR, 2017		
